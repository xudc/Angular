...
describe('Animation Tests', () => {
  ...
  describe('Status Slider Component', () => {
    ...
    it('should be inactive with an blue background', async () => {
      ...
      if (text === 'Active') {
        await toggleButton.click();
        await browser.wait(async () => await container.getCssValue('backgroundColor') === inactiveColor, 2125);
      }
    ...
    it('should be active with a orange background', async () => {
      ...
      if (text === 'Inactive') {
        await toggleButton.click();
        await browser.wait(async () => await container.getCssValue('backgroundColor') === activeColor, 2125);
      }
